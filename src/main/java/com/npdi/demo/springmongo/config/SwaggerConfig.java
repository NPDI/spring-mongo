...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.npdi.demo.springmongo.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "Spring-Mongo",
                "Esta API é utilizada no aprendizado de Spring Boot e MongoDB",
                "Versão 1.0",
                "https://www.udemy.com/terms",
                new Contact("NPDI", "www.fai-mg.br/npdi", "diegodulval@fai-mg.br"),
