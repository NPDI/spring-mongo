...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("20/02/2018"), "Partiu Viagem", "Vou viajar pra Dublin! Abraços...", diego);
        Post post2 = new Post(null, sdf.parse("06/03/2018"), "Viagem Foi Otíma!", "Muito legal, obrigado pelo apoio!", diego);
